...
namespace Catch {
    ...
    class LazyExpression {
        ...
        ITransientExpression const* m_transientExpression = __nullptr;
        bool m_isNegated;
    public:
...
namespace Catch {
    ...
    inline std::size_t registerTestMethods() {
        ...
        int noClasses = objc_getClassList( __nullptr, 0 );
...
namespace Catch {
    ...
    class TestSpecParser {
        ...
        TestSpec m_testSpec;
        ITagAliasRegistry const* m_tagAliases = __nullptr;
...
namespace Catch {
    ...
    class Option {
    public:
        Option() : nullableValue( __nullptr ) {}
        Option( T const& _value )
        : nullableValue( new( storage ) T( _value ) )
        {}
        Option( Option const& _other )
        : nullableValue( _other ? new( storage ) T( *_other ) : __nullptr )
        {}
        ...
        bool some() const { return nullableValue != __nullptr; }
        bool none() const { return nullableValue == __nullptr; }

        bool operator !() const { return nullableValue == __nullptr; }
        explicit operator bool() const {
            return some();
        }
...
namespace Catch {
    ...
    public:
        ...
        private:
            mutable XmlWriter* m_writer = __nullptr;
        };
...
namespace TestCaseTracking {
    ...
    class TrackerContext {
        ...
        ITracker* m_currentTracker = __nullptr;
...
namespace Catch {
    ...
    private:
        ...
        TestCase const* m_activeTestCase = __nullptr;
...
namespace Catch {
    ...
    LazyExpression::operator bool() const {
        return m_transientExpression != __nullptr;
    }
...
namespace detail {
    ...
    struct Parser : ParserBase {
        ...
        auto parse( std::string const& exeName, TokenStream const &tokens ) const -> InternalParseResult override {
            ...
            struct ParserInfo {
                ParserBase const* parser = __nullptr;
                size_t count = 0;
            };
...
namespace Catch {
    ...
    clara::Parser makeCommandLineParser( ConfigData& config ) {
        ...
        auto const setRngSeed = [&]( std::string const& seed ) {
                ...
                config.rngSeed = static_cast<unsigned int>( std::time(__nullptr) );
                return ParserResult::ok( ParseResultType::Matched );
            };
...
namespace Catch {
    ...
    private:
        IConfigPtr m_config;
        IRunner* m_runner = __nullptr;
        IResultCapture* m_resultCapture = __nullptr;
    };

    IMutableContext *IMutableContext::currentContext = __nullptr;
    ...
    void cleanUpContext() {
        ...
        IMutableContext::currentContext = __nullptr;
    }
...
namespace Catch {
        ...
        bool isDebuggerActive(){
            ...
            size = sizeof(info);
            if( sysctl(mib, sizeof(mib) / sizeof(*mib), &info, &size, __nullptr, 0) != 0 ) {
...
namespace Catch {
    ...
    std::string ExceptionTranslatorRegistry::translateActiveException() const {
        try {
            ...
            // causing a crash.
            if (std::current_exception() == __nullptr) {
...
namespace Catch {
    ...
    FatalConditionHandler::FatalConditionHandler() {
        ...
        exceptionHandlerHandle = __nullptr;
...
PVOID FatalConditionHandler::exceptionHandlerHandle = __nullptr;
...
namespace Catch {
    ...
    void FatalConditionHandler::reset() {
        if( isSet ) {
            ...
            for( std::size_t i = 0; i < sizeof(signalDefs)/sizeof(SignalDefs); ++i ) {
                sigaction(signalDefs[i].id, &oldSigActions[i], __nullptr);
            }
            // Return the old stack
            sigaltstack(&oldSigStack, __nullptr);
            isSet = false;
        }
    }
...
namespace Catch {
    ...
    class ListeningReporter : public IStreamingReporter {
        ...
        IStreamingReporterPtr m_reporter = __nullptr;
...
namespace Catch {
    ...
    class Singleton : SingletonImplT, public ISingleton {
        ...
        static auto getInternal() -> Singleton* {
            static Singleton* s_instance = __nullptr;
            if( !s_instance ) {
...
namespace Catch {
    ...
    Totals RunContext::runTest(TestCase const& testCase) {
        ...
        m_activeTestCase = __nullptr;
        m_testCaseTracker = __nullptr;
...
namespace Catch {
    ...
    namespace {
        static auto getSingletons() -> std::vector<ISingleton*>*& {
            static std::vector<ISingleton*>* g_singletons = __nullptr;
            if( !g_singletons )
...
namespace TestCaseTracking {
    ...
    ITracker& TrackerContext::startRun() {
        m_rootTracker = std::make_shared<SectionTracker>( NameAndLocation( "{root}", CATCH_INTERNAL_LINEINFO ), *this, __nullptr );
        m_currentTracker = __nullptr;
        m_runState = Executing;
